...
def main(args):
    ...
    model = NPVAE.Chem_VAE(args.x_size, args.h_size, args.mid_size, args.z_dim, 0, 13681, args.max_iter, labels, None, None, None, None, None, args.device, "test")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_path", type = str,
                        default = "./output_data", help = "Path to save latent variables and other output values")
